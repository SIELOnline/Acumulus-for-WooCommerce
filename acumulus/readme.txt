...
3. Go to the 'Settings - Acumulus' page (`wp-admin/options-general.php?page=acumulus`) to configure the plugin.
...
7. To cater for specific use cases, the plugin does define some filters and actions. See the separate filters.txt for more information.
